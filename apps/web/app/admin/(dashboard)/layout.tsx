...
export default async function AdminDashboardLayout({
  ...
  const navItems = [
    ...
    { label: 'Pesanan Masuk', href: '/admin/orders', icon: ShoppingCart },
    { label: 'Pengiriman & Resi', href: '/admin/shipments', icon: Truck },
    { label: 'Data Pelanggan', href: '/admin/customers', icon: Users },
    { label: 'Buku Besar Pembayaran', href: '/admin/payments', icon: DollarSign },
    { label: 'Kupon Promo', href: '/admin/coupons', icon: Ticket },
    { label: 'Moderasi Ulasan', href: '/admin/reviews', icon: Star },
    { label: 'Audit Log & Keamanan', href: '/admin/audit-logs', icon: ShieldCheck },
  ];
